      ...
      <nav className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          {/* <a href="#home" className="flex items-center gap-2">
            <img src={logo} alt="Arsip Perencana" className="h-24 w-auto" />
          </a> */}
        ...
        {/* Mobile Menu */}
        {isMobileMenuOpen && (
          <div className="md:hidden absolute top-full left-0 right-0 bg-card shadow-card animate-fade-in">
              ...
              {navLinks.map((link) => (
                <li key={link.name}>
                  <a
                    ...
                    className="block px-6 py-3 text-foreground/80 hover:text-primary hover:bg-muted font-medium transition-colors"
                  >
                    {link.name}
                  </a>
                </li>
